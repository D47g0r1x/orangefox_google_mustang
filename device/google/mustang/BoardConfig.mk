...
# Recovery / General Options & Utilities
...
# -----------------------------------------------------------------------------
OF_MAINTAINER := "D47g0r1x"
FOX_VERSION := "R12.1_Beta"
FOX_BUILD_TYPE := "Beta"
FOX_VENDOR_BOOT_RECOVERY := 1
OF_VENDOR_BOOT_RECOVERY := 1
FOX_USE_TWRP_RECOVERY_IMAGE_BUILDER := 1

# Screen & Status Bar Geometry (Pixel 10 Pro XL: 1344x2992, punch hole display)
OF_SCREEN_H := 2992
OF_STATUS_H := 110
...
OF_FL_PATH1 := /sys/class/backlight/panel0-backlight/brightness
OF_USE_MAGISKBOOT := 1
